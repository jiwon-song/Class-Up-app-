...
import static com.example.project01.common.CommonMethod.studentInfoDTO;
...
import com.example.project01.ATask.StudentInfoSelect;
import com.google.android.material.navigation.NavigationView;
import com.google.android.material.tabs.TabLayout;

import java.util.concurrent.ExecutionException;

public class TStudentInfo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        StudentInfoSelect studentInfoSelect = new StudentInfoSelect(student_id);
        try {
            studentInfoSelect.execute().get();
        ...
        studentname_detail.setText(studentInfoDTO.getStudent_name()+ "님의 상세정보");
        ...
        nav_view.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                if (id == R.id.nav_logout) {
                    ...
                    new AlertDialog.Builder(TStudentInfo.this)
                            .setTitle("로그아웃")
                            ...
                            .setPositiveButton("로그아웃", new DialogInterface.OnClickListener() {
                                ...
                                public void onClick(DialogInterface dialog, int which) {
                                    ...
                                    Intent intent = new Intent(TStudentInfo.this, TLogin.class);
                                    ...
                                    editor.clear();
                                    editor.commit();
                                    Toast.makeText(TStudentInfo.this, "로그아웃.", Toast.LENGTH_SHORT).show();
                                    finishAffinity();
                                }
                            })
                    ...
                    new AlertDialog.Builder(TStudentInfo.this)
                            ...
                            .setPositiveButton("탈퇴", new DialogInterface.OnClickListener() {
                                ...
                                public void onClick(DialogInterface dialog, int which) {
                                    ...
                                    if (state.equals("1")) {
                                        Toast.makeText(TStudentInfo.this,
                                        ...
                                        Toast.makeText(TStudentInfo.this, "회원 탈퇴에 실패하였습니다", Toast.LENGTH_SHORT).show();
                                    }
