...
import com.example.project01.ATask.ClassSelect;
...
public class TClassList extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tclass_list);
        ...
        // 어댑터 객체 생성
        classAdapter = new ClassAdapter(TClassList.this,dtos);
        ...
        ClassSelect classSelect = new ClassSelect(dtos, classAdapter, teacher_id);
        classSelect.execute();
        ...
        nav_view.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                if (id == R.id.nav_logout) {
                    ...
                    new AlertDialog.Builder(TClassList.this)
                            .setTitle("로그아웃")
                            ...
                            .setPositiveButton("로그아웃", new DialogInterface.OnClickListener() {
                                ...
                                public void onClick(DialogInterface dialog, int which) {
                                    ...
                                    Intent intent = new Intent(TClassList.this, TLogin.class);
                                    ...
                                    editor.clear();
                                    editor.commit();
                                    Toast.makeText(TClassList.this, "로그아웃.", Toast.LENGTH_SHORT).show();
                                    finish();
                                }
                            })
                    ...
                    new AlertDialog.Builder(TClassList.this)
                            ...
                            .setPositiveButton("탈퇴", new DialogInterface.OnClickListener() {
                                ...
                                public void onClick(DialogInterface dialog, int which) {
                                    ...
                                    if (state.equals("1")) {
                                        Toast.makeText(TClassList.this,
                                        ...
                                        Toast.makeText(TClassList.this, "회원 탈퇴에 실패하였습니다", Toast.LENGTH_SHORT).show();
                                    }
